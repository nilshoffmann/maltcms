...
public class ANDIMSExporter extends AFragmentCommand {
    ...
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(ANDIMSExporter.class);
    ...
    public TupleND<IFileFragment> apply(TupleND<IFileFragment> t) {
        ...
        for (IFileFragment f : t) {
            ...
            Set<VariableInfo> defaultVariables = new LinkedHashSet<>();
    ...
    private List<Attribute> updateScanIndexCount(List<Attribute> attributes, int scanCount) {
        List<Attribute> modified = new ArrayList<>(attributes);
        int i = 0;
