...
public class AgilentPeakReportDataSourceTest {
    ...
    @Rule
    public ExtractClassPathFiles ecpf = new ExtractClassPathFiles(tf, "/xls/agilent/Ap 601.D.zip");
    ...
    private AgilentPeakReportDataSource getDataSource() {
        return new AgilentPeakReportDataSource();
    }

    @Test
    public void testReadTIC() throws Exception {
        sl.setLogLevel("cross.datastructures.fragments.BfsVariableSearcher", "INFO");
        for (File f : ecpf.getFiles()) {
            if (f.getName().equals("Ap 601.D")) {
                log.info("Checking report {}", f.getName());
                IFileFragment ff = new FileFragment(f);
                IVariableFragment tic = ff.addChild("total_intensity");
                try {
    ...
    /**
     * Test of canRead method, of class AgilentPeakReportDataSourceTest.
     */
    @Test
    public void testCanRead() throws Exception {
        sl.setLogLevel("cross.datastructures.fragments", "INFO");
        for (File f : ecpf.getFiles()) {
            try {
        ...
        sl.setLogLevel("cross.datastructures.fragments", "WARN");
    }

    /**
     * Test of readAll method, of class AgilentPeakReportDataSource.
     */
    @Test
    ...
    /**
     * Test of readIndexed method, of class AgilentPeakReportDataSource.
     */
    @Test
    ...
    /**
     * Test of readSingle method, of class AgilentPeakReportDataSource.
     */
    @Test
    ...
    /**
     * Test of readStructure method, of class AgilentPeakReportDataSource.
     */
    @Test
    public void testReadStructure_IFileFragment() throws Exception {
        for (File f : ecpf.getFiles()) {
            IFileFragment ff = new FileFragment(f);
    ...
    /**
     * Test of supportedFormats method, of class AgilentPeakReportDataSource.
     */
    @Test
    public void testSupportedFormats() {
        System.out.println("supportedFormats");
        AgilentPeakReportDataSource instance = new AgilentPeakReportDataSource();
        List expResult = Arrays.asList("d");
        List result = instance.supportedFormats();
        assertEquals(expResult, result);
    }

    /**
     * Test of write method, of class AgilentPeakReportDataSource.
     */
//	@Test
...
////		boolean result = instance.write(f);
////		assertEquals(expResult, result);
