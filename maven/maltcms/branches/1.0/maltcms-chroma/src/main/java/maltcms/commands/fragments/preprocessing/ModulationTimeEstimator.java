 ...
 * 
 * $Id: ModulationTimeEstimator.java 160 2010-08-31 19:55:58Z nilshoffmann $
 */
...
public class ModulationTimeEstimator extends AFragmentCommand {
    ...
    private ArrayList<Array> buildTIC2D(final int scansPerModulation,
        ...
        this.log.info(
                "Building TIC arrays with fixed number of scans per modulation");
    ...
    protected void findSecondRetentionTimes(final IFileFragment ff,
        ...
        final double satMax = sma[1].get(
                cross.datastructures.Vars.Max.toString());
        final double satMin = sma[1].get(
                cross.datastructures.Vars.Min.toString());
        ...
        final HeatMapChart hmc = new HeatMapChart(bi, "time 1 [s]",
                ...
                (int) (this.secondColumnTime * this.scanRate), tic.getShape()[0],
                satMean), ff.getAbsolutePath());
    ...
    protected Tuple2D<ArrayDouble.D1, ArrayDouble.D1> getModulationTime(
        ...
        final ArrayDouble.D1 modtimes = new ArrayDouble.D1(
