 ...
 * 
 * $Id: DTW2DTicVisualizer.java 160 2010-08-31 19:55:58Z nilshoffmann $
 */
...
public class DTW2DTicVisualizer extends AFragmentCommand {
	...
	@Configurable(name = "maltcms.ui.charts.PlotRunner.serializeJFreeChart", value = "true")
	private boolean createSerialized = true;
	@Configurable(name = "maltcms.ui.charts.PlotRunner.filetype", value = "png")
	private final String format = "png";
	@Configurable(value = "maltcms.commands.fragments2d.warp.visualization.Default2DTWVisualizer")
	...
	public void configure(final Configuration cfg) {
		...
		this.visualizerClass = cfg
				.getString(this.getClass().getName() + ".visualizerClass",
	...
	private void createChart(final IFileFragment ref,
		...
		final JFreeChart chart = this.visualizer
				.createChart(in.getAbsolutePath(), ref.getName(), query
						.getName(),
