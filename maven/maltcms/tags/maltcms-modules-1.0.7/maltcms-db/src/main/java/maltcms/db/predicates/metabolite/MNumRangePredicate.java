    	...
    	try {
			...
			if(val instanceof Number) {
				...
				if(val instanceof Float) {
					return ((lB.floatValue()<=n.floatValue()) && (n.floatValue()<=uB.floatValue()));
				}
				if(val instanceof Double) {
					return ((lB.doubleValue()<=n.doubleValue()) && (n.doubleValue()<=uB.doubleValue()));
				}
				if(val instanceof Integer) {
					return ((lB.intValue()<=n.intValue()) && (n.intValue()<=uB.intValue()));	
				}
				if(val instanceof Long) {
					return ((lB.longValue()<=n.longValue()) && (n.longValue()<=uB.longValue()));	
				}
			}
