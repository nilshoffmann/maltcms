...
public class MetaboliteQueryDB extends QueryDB<IMetabolite> {
	...
	public MetaboliteQueryDB(String dblocation, String[] args, MAggregatePredicateFactory mapf) {
	...
	public static void main(String[] args) {
		...
		if(args.length>=1) {//at least the db has to be given
			...
			System.out.println("Usage: java maltcms.db.MetaboliteQuery /PATH/TO/DB [PREDICATES]");
		}
	}
