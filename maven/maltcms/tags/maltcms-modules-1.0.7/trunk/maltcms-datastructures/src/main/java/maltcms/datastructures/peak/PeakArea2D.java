 ...
 * 
 * $Id: PeakArea2D.java 160 2010-08-31 19:55:58Z nilshoffmann $
 */
...
public class PeakArea2D {
	...
	public boolean regionContains(final Point point) {
		final boolean pixelMapContainsPoint = this.pixelMap
				.containsKey(getIndex(point));
...
//	public double getIntensitiyFor(Point p) {
//		if (this.intensities.containsKey(p)) {
//			return this.intensities.get(p);
//		}
//		return 0;
//	}
