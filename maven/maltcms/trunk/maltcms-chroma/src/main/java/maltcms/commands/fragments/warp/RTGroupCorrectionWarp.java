 ...
 * 
 * $Id: RTGroupCorrectionWarp.java 160 2010-08-31 19:55:58Z nilshoffmann $
 */
...
public class RTGroupCorrectionWarp extends AFragmentCommand {
    ...
    public IFileFragment copyReference(final IFileFragment ref,
        ...
        final IFileFragment copy = Factory.getInstance().getFileFragmentFactory().
                create(
    ...
    public IFileFragment warp(final IFileFragment ref,
        ...
        this.log.info("Warping {}, saving in {}", originalFile.getAbsolutePath(),
                processedFile.getAbsolutePath());
        final IFileFragment warped = Factory.getInstance().
                getFileFragmentFactory().create(
                new File(getWorkflow().getOutputDirectory(this),
                StringTools.removeFileExt(originalFile.getName())
                + ".cdf"));
    ...
    public double getMedianRT(final IFileFragment top,
