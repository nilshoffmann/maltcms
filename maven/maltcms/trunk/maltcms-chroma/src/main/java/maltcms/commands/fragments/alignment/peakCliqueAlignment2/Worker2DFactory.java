...
import maltcms.datastructures.feature.PairwiseValueMap.StorageType;
...
public class Worker2DFactory implements IWorkerFactory {
    ...
    @Configurable
    private PairwiseValueMap.StorageType storageType = StorageType.ROW_COMPRESSED;
    @Configurable
    ...
    public Worker2DFactory() {
        ...
        peakLoader.setPeakFactory(new Peak2DMSFactory());
    }
