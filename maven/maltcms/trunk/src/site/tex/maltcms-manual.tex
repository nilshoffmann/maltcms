...
\lstset{language=Java,numbers=left,backgroundcolor=\color{codebg},keywordstyle=\bfseries\ttfamily\color{darkred},
...
\lstinputlisting[firstline=52,lastline=75,float,caption=Programmatic assembly of a workflow,label=lst:myWorkflow]{../../../maltcms-chroma/src/main/java/net/sf/maltcms/tutorials/MyWorkflow.java}
