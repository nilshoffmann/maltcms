...
public class Data2DNormalizer extends AFragmentCommand {
    ...
    public TupleND<IFileFragment> apply(TupleND<IFileFragment> t) {
        ...
        for (IFileFragment ff : t) {
            ...
            retF.getChild(this.totalIntensityFilteredVar).setIndex(index);
            createImage(retF.getChild(this.totalIntensityFilteredVar).getIndexedArray(), scansPerModulation, ff, "afterFilter");
