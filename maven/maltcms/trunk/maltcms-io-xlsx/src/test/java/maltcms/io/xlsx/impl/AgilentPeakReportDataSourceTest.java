...
public class AgilentPeakReportDataSourceTest {
    ...
    @Rule
    public ExtractClassPathFiles ecpf = new ExtractClassPathFiles(tf, "/xls/agilent/REPORT01.xls.gz");
	...
	@Test
	public void testReadTIC() {
		for(File f:ecpf.getFiles()) {
			if(f.getName().equals("REPORT01.xls")) {
...
//            FileFragment.clearFragments();
	...
	public void testSupportedFormats() {
		...
		List expResult = Arrays.asList("xls","xlsx");
