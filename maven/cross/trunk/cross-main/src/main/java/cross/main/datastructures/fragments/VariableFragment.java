 ...
 * for details.
 */
package cross.main.datastructures.fragments;
...
import cross.main.datastructures.tools.ArrayTools;
import cross.main.datastructures.tools.EvalTools;
import cross.main.io.misc.ArrayChunkIterator;
import cross.main.io.misc.Base64;
    ...
    public void setArray(final Array a1) {
        ...
        if (a1 == null) {
            ...
            if (getDimensions() == null) {
                setDimensions(cross.main.datastructures.tools.ArrayTools.getDefaultDimensions(a1));
            }
        }
    }
