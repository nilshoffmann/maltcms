        ...
        if (getArrayRef() == null) {
            if (this.al == null) {
                try {
                    ...
                    setArrayInternal(GlobalContext.getContext().getBean(
                            IDataSourceFactory.class).
                            getDataSourceFor(
                ...
                if (this.isModified) {
                    this.a = cross.tools.ArrayTools.glue(this.al);
                } else {
                    setArrayInternal(cross.tools.ArrayTools.glue(this.al));
                }
            }
        }
        return getArrayRef();
            ...
            if (getIndex() == null) {
                ...
                if (this.useCachedList) {
                    ...
                    try {
                        ...
                        setIndexedArrayInternal(GlobalContext.getContext().
                                getBean(IDataSourceFactory.class).
                                getDataSourceFor(
