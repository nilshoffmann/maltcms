...
public class FileFragment implements IFileFragment {
    ...
    private void setSourceFiles(final Collection<IFileFragment> files) {
        ...
        final String sfvar = GlobalContext.getContext().getBean(IControlledVocabularyManager.class).getTerm("var.source_files");
    ...
    public synchronized IVariableFragment getChild(final String varname,
        ...
        if (this.children.containsKey(varname)) {
            ...
            String sourceFileVarName = Lookup.getDefault().lookup(IControlledVocabularyManager.class).getTerm("var.source_files");
            ...
            try {
                if (loadStructureOnly) {
                    GlobalContext.getContext().getBean(IDataSourceFactory.class).getDataSourceFor(this).readStructure(vf);
                } else {
                    GlobalContext.getContext().getBean(IDataSourceFactory.class).getDataSourceFor(this).readSingle(vf);
                }
                EvalTools.notNull(vf, this);
    ...
    private void removeSourceFilesVariableFragment() {
        final String sfvar = Lookup.getDefault().lookup(IControlledVocabularyManager.class).getTerm("var.source_files");
        if (hasChild(sfvar)) {
    ...
    public boolean save() {
        ...
        if (GlobalContext.getContext().getBean(IDataSourceFactory.class).getDataSourceFor(this).write(this)) {
            clearArrays();
            return true;
        }
        return false;
