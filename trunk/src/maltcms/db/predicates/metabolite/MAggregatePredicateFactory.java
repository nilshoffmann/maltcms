...
import maltcms.db.predicates.PublicMemberGetters;
...
//					} catch (NumberFormatException nfe3) {
	...
	private MNumRangePredicate handleFP(String[] range, Method m) {
		...
		Double d1 = Double.parseDouble(range[0]);
		Double d2 = Double.parseDouble(range[1]);
	...
	private MNumRangePredicate handleIntegral(String[] range, Method m) {
		MNumRangePredicate mnrp;
		Long l1 = Long.parseLong(range[0]);
		Long l2 = Long.parseLong(range[1]);
