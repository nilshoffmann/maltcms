...
public class ArrayTools2 {
	 ...
	 *            source
	 * @param hold
	 *            mass values which will be hold
	 * @param retNew
	 *            return a new array or the source array with 0.0d at all non
	 *            hold positions
	 * @return sparse array
	 */
	@Deprecated
	 ...
	 *            list of indices
	 * @param exclude
	 *            <code>true</code> if the indices should be excluded
	 * @return new array
	 */
	 ...
	 *            array
	 * @param list
	 *            indices which will be removed (set to 0.0d).
	 ...
	 *            array
	 * @param list
	 *            indices which will be used other will set to 0.0d.
	 * @return an copy of the list
	 */
	...
	public static Array[] glue(List<Tuple2D<Array, Array>> scanlineMS,
		...
		return new Array[] { scanIndex, cross.tools.ArrayTools.glue(mzs),
				cross.tools.ArrayTools.glue(inten) };
	}
}
