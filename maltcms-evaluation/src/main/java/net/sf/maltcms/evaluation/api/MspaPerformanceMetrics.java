...
/**
 * <p>MspaPerformanceMetrics class.</p>
 *
 * @author Nils Hoffmann
 * 
 */
public final class MspaPerformanceMetrics {
    ...
    /**
     * <p>Constructor for MspaPerformanceMetrics.</p>
     *
     ...
     */
    public MspaPerformanceMetrics(String toolname, int tp, int fp, int tn, int fn, int N, int M, int K, double dist, HashSet<EntityGroup> unmatchedTool, HashSet<EntityGroup> unmatchedGroundTruth) {
