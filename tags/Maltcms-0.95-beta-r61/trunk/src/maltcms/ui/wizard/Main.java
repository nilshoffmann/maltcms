...
public class Main implements WizardPage.WizardResultProducer{
    ...
    public static void main(String[] args) {
        Main m = new Main();
        Wizard w =  WizardPage.createWizard(
        new Class[] {
            FileInputOutputPane.class, AnchorDefinitionPane.class, PreprocessingPane.class, AlignmentPane.class, VisualizationPane.class},
        m);
