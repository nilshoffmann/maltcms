...
public class AlignmentPane extends WizardPage {
    ...
    private void initComponents() {
        ...
        jTextField1.setToolTipText("Number of scans to consider aroung each anchor");
        ...
        jTextField2.setToolTipText("Percentage of maximum allowed lag between chromatograms (between 0 and 1)");
    ...
    protected DefaultComboBoxModel getLocalSimDistComboBoxModel() {
        if(this.dcbm==null) {
            this.dcbm = new DefaultComboBoxModel(new String[]{"Cosine Similarity","Linear Correlation Similarity","Hamming Distance","Euclidean Distance","TIC Squared Distance"});
        }
        return this.dcbm;
    }
