...
public class PipelineWizard implements WizardResultProducer, HyperlinkListener,
	...
	public static void main(String[] args) {
		...
		Runnable r = new Runnable() {
			...
			private void createChromAFrame() {
				...
				//EditConfigurationAction editConfigAction = (EditConfigurationAction) pw
	...
	public JFrame getConfigurationEditor() {
		if (this.pe == null) {
			...
			addListener(this.pe);
			// this.cfgEditorFrame = new JFrame();
			// this.cfgEditorFrame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
			// this.cfgEditorFrame.add(new JScrollPane(this.pe));
		}
		return this.pe;
	}
		...
		if (gatheredSettings != null) {
			...
			for (Object key : gatheredSettings.keySet()) {
				...
				if (key.equals("alignment.algorithm.distance")) {
					...
					if (value.equals("Cosine Similarity")) {
