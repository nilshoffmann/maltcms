...
public class SparseColtvsMultiArray {
	...
	public void run() {
		final StatsMap coltsm = new StatsMap(FileFragmentFactory.getInstance()
		        .getFragment("colt.csv", null));
		final StatsMap masm = new StatsMap(FileFragmentFactory.getInstance()
		        .getFragment("ma.csv", null));
		final StatsMap madensem = new StatsMap(FileFragmentFactory
		        .getInstance().getFragment("madense.csv", null));
		final StatsMap medialibm = new StatsMap(FileFragmentFactory
		        .getInstance().getFragment("medialib.csv", null));
