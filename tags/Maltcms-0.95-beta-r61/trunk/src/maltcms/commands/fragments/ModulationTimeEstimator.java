...
public class ModulationTimeEstimator extends AFragmentCommand {
	...
	public TupleND<IFileFragment> apply(final TupleND<IFileFragment> t) {
		...
		for (final IFileFragment ff : t) {
			final IFileFragment fret = FileFragmentFactory.getInstance()
			        .create(
			                FileTools.prependDefaultDirs(ff.getName(), this
			                        .getClass(), getIWorkflow()
			                        .getStartupDate()), this.getClass());
	...
	protected void findSecondRetentionTimes(final IFileFragment ff,
		...
		final BufferedImage bi = ImageTools.fullSpectrum(ff.getName(), tic2D,
		        ...
		        true, this.threshold);
		ImageTools.saveImage(bi, ff.getName() + "-chromatogram", "png", this
		        .getClass(), this);
