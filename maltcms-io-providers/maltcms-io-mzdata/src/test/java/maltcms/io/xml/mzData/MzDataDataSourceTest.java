...
public class MzDataDataSourceTest {
    ...
    @Rule
    public ExtractClassPathFiles ecpf = new ExtractClassPathFiles(tf, "/mzData/jmzreader-mzdata_example.mzdata.xml.gz", "/mzData/tiny1.mzData1.05.mzData.xml.gz");

    MZDataDataSource getDataSource() {
        return new MZDataDataSource();
    }
    ...
    @Before
    public void setUp() {
        Factory.getInstance().getDataSourceFactory().setDataSources(Arrays.asList(MZDataDataSource.class.getCanonicalName()));
